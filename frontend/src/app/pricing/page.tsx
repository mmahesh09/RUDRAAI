          ...
          <Pricing
            ...
            tiers={[
              ...
              },
              {
                ...
                isPrimary: true,
                features: [
                  { text: "Up to 5 automation workflows/month" },
              ...
              {
                name: "Custom",
                description: "Need something specific? We'll build exactly what your business requires.",
                priceLabel: "Let's talk",
                buttonText: "Contact Us",
                buttonHref: "/contact",
                features: [
                  { text: "Fully bespoke AI automation systems" },
